...
import competition.cig.robinbaumgarten.astar.NNSimulator;
import competition.cig.robinbaumgarten.astar.sprites.Mario;

public class NNAgent implements Agent
{
    protected boolean action[] = new boolean[Environment.numberOfButtons];
    protected String name = "MatteoSebas_NNAgent";
    private NNSimulator sim;
	...
	/* gets the next move for mario based on observations */
